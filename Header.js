        ...
        <div className="header">
            ...
            <div className='header__nav'>
                <div className='header__option' onClick={handleAuthentication}>
                    <Link to={!user && "/login"}>
                        <span className='header__optionLineOne'>Hello,{user ? <p>{user.email}</p> : "User"}</span>
                        <div>
